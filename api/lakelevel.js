export default async function handler(req, res) {
  ...
  res.json({level:Number(level.toFixed(2)),gageHeight:Number((level-500).toFixed(2)),time:new Date().toISOString(),source:level===504.10?'Estimated LIVE':'Bizer.com LIVE',fullPool:FULL_POOL,live:true});
}
